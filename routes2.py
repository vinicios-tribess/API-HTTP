...
def cadastro_respostas(id_aluno):
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS respostas (id_aluno integer not null, prova integer not null, questao integer not null, resposta text not null, PRIMARY KEY (id_aluno, prova, questao))")
...
def consulta_notas_finais():
    ...
    # Separa uma lista com as IDs dos alunos e outra com os nomes:
